...
/**
 * Class MemberCreateStoreRequest
 *
 * @package App\Adapters\Http\Requests\Admin
 */
class MemberCreateStoreRequest extends Request
{
    /**
     * バリデーションチェック定義
     *
    ...
    public function rules()
    {
        ...
        $facultyTypeListKeys = array_keys(School::FACULTY_TYPE_LIST);
        ...
        $validators = [
            ...
            // 郵便番号
            'zipCode' => ['required', 'digits:7', 'regex:/^[0-9]+$/'],
            // 都道府県
            ...
            // 学校名
            'schoolName' => ['required', 'max:24', 'halfwidth_kana_control'],
            // 学部・学科名
            'departmentName' => ['required', 'max:24', 'halfwidth_kana_control'],
            // 学部系統
            ...
            'recruitInfoNeeded' => ['required', 'in:0,1'],
            // TOEIC
    ...
    public function messages()
    {
        ...
        $messages = [
            ...
            'zipCode.digits' => trans('validation.digits', ['name' => '郵便番号']),
            ...
            // 募集要項
            'recruitInfoNeeded.required' => trans('validation.choice.required', ['name' => '募集要項']),
            'recruitInfoNeeded.in' => trans('validation.choice.in', ['name' => '募集要項']),
            // TOEIC
