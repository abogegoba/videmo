...
/**
 * Interface MemberEntryConfirmInitializeOutputPort
 *
 ...
 * @property string $graduationPeriodTypeLabel 卒業年月種別
 * @property string $industry1 志望業種1
 * @property string $industry2 志望業種2
 * @property string $industry3 志望業種3
 * @property string $location1 志望勤務地1
 * @property string $location2 志望勤務地2
 * @property string $location3 志望勤務地3
 * @property string $intern インターン希望
 * @property string $recruitInfo 募集情報が必要です
